    ...
    async start() {
        ...
        play(){
            ...
            background("white");
              ...
              Bow1.push(new Bow(100,300,70,70));
              Bow2.push(new Bow(700,300,70,70));
              ...
              /*bottomGroung=new Ground(600,405,1200,20);
              wall=new Ground(600,200,1200,400);*/
            ...
            if(frameCount%2000===0){
              ...
              for (var r = 0; r < redloon.length; r++) {
                redloon[r].display();   
              }
